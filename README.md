...
<div style="display: flex; justify-content: center;">
    <img src="./icons/NHERI-WEUQ-GUI_EVT_IsolatedBuilding.svg" alt="WE-UQ GUI - EVT - CFD on Isolated Building - Willis Tower" width="45.5%" style="outline: 2px solid black;"/>
