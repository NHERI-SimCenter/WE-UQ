...
set floorLoc [lindex $floorLocations [expr $floor-1]]
node 11 0 0 [lindex $floorLocations 0]
node 12 0 0 [lindex $floorLocations 1] -mass $floorMass $floorMass 0. 0. 0. 1e3
node 13 0 0 [lindex $floorLocations 2] -mass $floorMass $floorMass 0. 0. 0. 1e3
node 14 0 0 [lindex $floorLocations 3] -mass $roofMass  $roofMass  0. 0. 0. 1e3
...
uniaxialMaterial Elastic 4 $rz

element zeroLength 1 11 12 -mat 1 1 4 -dir 1 2 6 -doRayleigh
element zeroLength 2 12 13 -mat 2 2 4 -dir 1 2 6 -doRayleigh
element zeroLength 3 13 14 -mat 3 3 4 -dir 1 2 6 -doRayleigh
