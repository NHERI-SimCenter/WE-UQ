...
namespace Foam
{
    defineTypeNameAndDebug(sixDoFElasticBodyMotionSolver, 0);
...
Foam::sixDoFElasticBodyMotionSolver::sixDoFElasticBodyMotionSolver
(
    const polyMesh& mesh,
...
:
    ...
    coupling_(coeffDict().lookupOrDefault<Switch>("coupling", false)),
    rhoInf_(1.0),
...
const Foam::sixDoFElasticBodyMotion&
Foam::sixDoFElasticBodyMotionSolver::motion() const
{
    return motion_;
}
...
Foam::sixDoFElasticBodyMotionSolver::curPoints() const
{
    return points0() + pointDisplacement_.primitiveField();
}


void Foam::sixDoFElasticBodyMotionSolver::solve()
{
...
bool Foam::sixDoFElasticBodyMotionSolver::writeObject
(
...
bool Foam::sixDoFElasticBodyMotionSolver::read()
{
